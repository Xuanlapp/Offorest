...
Only redesign artwork on the surface of the shape: (texting, pet, person, pattern, flowers, trees, plants, sun, moon, landscape or objects depicted on the ornament) NOT change artwork type
A photorealistic image of the SAME shape as the original reference.
...
Redesign the character's appearance (e.g., change the pet breed, person's hairstyle, flowers, objects, trees, plants, landscape, mountains, or objects depicted on the ornament) while maintaining the same overall vibe and emotional tone, keep same type of character (e.g., if it's a pet, keep it a pet; if it's a person, keep it a person)
...
blurry, low quality, warped print/label, distorted design, unreadable text, wrong colors, extra typography, extra text, watermark, random logo, harsh glare covering design, messy background, overexposed, underexposed, low contrast, oversaturated, bad anatomy, extra fingers, deformed hands, duplicated limbs`,
    holographicOrnament: `You are a professional designer creating artwork for a 2D ornament for the Etsy print-on-demand market.
...
A photorealistic image of the phonecase, shape as the original reference.
Keep the exactly shape structure, proportions, perspective, and material unchanged.
Only redesign the printed artwork on the surface of the shape: (text, pet, person, pattern, or object depicted on the ornament) NOT change artwork type
A photorealistic image of the SAME shape as the original reference.
Keep the same lighting direction and intensity, including highlights, shadows, and overall ambiance
Keep the same surface, object placement, and compostion structure as the reference image
Retain the original art style and rendering technique (line weight, shading style, color blending)
Redesign the character's appearance (e.g., change the pet breed, person's hairstyle,) while maintaining the same overall vibe and emotional tone, keep same type of character (e.g., if it's a pet, keep it a pet; if it's a person, keep it a person)
Ensure the character remains the clear focal point and feels naturally integrated into the existing design language
...
Ensure colors and shading interact naturally with the detected material type
Output instructions:
Show only one the phonecase artwork
Change the background
No mockup, no rope, no product photography
No watermarks, no borders, no logos
High resolution, print-ready design`,
Ornament_real: `You are a professional designer creating artwork for a 2D ornament for the Etsy print-on-demand market.
...
Output instructions:
Show only one the ornament artwork
Change the background
No mockup, no rope, no product photography
No watermarks, no borders, no logos
High resolution, print-ready design`,
